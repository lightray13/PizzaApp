package com.pizza.application.di
...
import com.pizza.application.data.local.preferences.SharedPreferenceStorage
...
class ApplicationModule {
    ...
    @Provides
    @Singleton
    fun provideDatabase(@ApplicationContext context: Context): PizzaDatabase = PizzaDatabase.buildDatabase(context)
